...
with open('models/survey.pickle', 'rb') as file:
    loaded_data = pickle.load(file)

def prediksi_penyakit_berdasarkan_gejala():
# Prediksi penyakit berdasarkan gejala yang diberikan pengguna
  ...
  return list(gejala_pengguna)

def prediksi_hasil(gejala_pengguna):
  ...
  if n > 2:
    ...
    print("\nMaaf gejala tidak menunjukkan adanya penyakit pada sapi anda")

  return list(kelas_lebih_dari_threshold)

if __name__ == '__main__':
  gejala_pengguna = prediksi_penyakit_berdasarkan_gejala()
  kelas_lebih_dari_threshold = prediksi_hasil(gejala_pengguna)
